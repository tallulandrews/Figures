...
png("Figure_UMI_FS.png", width=6*1.2, height=6, units="in", res=300)
layout(matrix(c(1,1,1,1,2,2,1,1,1,1,2,2), nrow=2, byrow=T))
par(mar=c(3.5,3.5,1,1))
QualityPlot(my_methods, paste("\n",my_FS_names, "\n"), c(my_FS_colours), zoom=FALSE)
dev.off();
...
png("Poster_UMI_FS_TopX.png", width=5, height=5*1.2, units="in", res=300)
par(mar=c(4,4,0,1))
