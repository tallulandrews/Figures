...
# Figure Setup
png("Figure3.png", width=6, height=8.5, units="in", res=300)
lhei=c(1,1,1*2/3)
lwid=c(1,1,1,1,1,1)
layout(matrix(c(rep(1,times=6), rep(c(2,3), each=3), rep(c(4,5,6), each=2)), ncol=6, byrow=T),heights=lhei, widths=lwid)
