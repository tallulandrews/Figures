...
for (t in 1:length(type)) {
	...
	png(paste("Poster_",type[t],"_Simulation_AUC.png", sep=""), width=6, height=6, units="in", res=500) # only fixed 6 Feb
	par(mar=c(3,4,1,1))
...
#	png(paste(type[t],"_Simulation_Recall.png", sep=""), width=6, height=6, units="in", res=300) # Only fixed 6 Feb
	par(mar=c(3,4,1,1))
